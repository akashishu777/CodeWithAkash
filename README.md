...
To view a live demo, [click here](https://akashishu777.github.io/CodeWithAkash/).
...
When creating a new Gatsby site, the CLI allows you to specify a starter, in this case simply provide the URL for this repo. This can be accomplished by running the command ```gatsby new YOUR_BLOG_NAME https://github.com/Akashishu777/CodeWithAkash```
...
export default {
  ...
  social: {
    website: '',
    github: 'https://github.com/Akashishu777',
